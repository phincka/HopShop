            ...
            CenterAlignedTopAppBar(
                ...
                actions = {
                    Row(
                        ...
                        IconButton(
                            onClick = {
                                viewModel.getListById("ppVYP6Y2CoTJfF8BQEbn")
                ...
                QRCodeScanner(
                    showBottomSheet = {
                        if (!isCreateItemDialogVisible && listId != it) {
                            listId = it
                            viewModel.getListBySharedCode(listId)
                            isCreateItemDialogVisible = true
                        }
                    }
                )
        ...
        AndroidView(factory = { ctx ->
            ...
            cameraProviderFuture.addListener({
                ...
                imageAnalysis.setAnalyzer(cameraExecutor) { imageProxy ->
                    ...
                    if (image.format == ImageFormat.YUV_420_888) {
                        ...
                        try {
                            ...
                            // No result found or decoding error
                        }
                    }
                ...
                try {
                    ...
                    Log.e("QRCodeScanner", "Camera error", exc)
                }
